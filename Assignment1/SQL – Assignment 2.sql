...
ALTER TABLE Trainee ADD COLUMN VTI_Account TINYINT UNSIGNED UNIQUE KEY NOT NULL;
...
VALUES 				(N'Trần Phú Đạt'		, '1997-10-07'	, 'M'		, '15'	, '13'		, '40'			, 'MSSQL13'		, N'Bài làm khá, cần cố gắng'),
					(N'Lê Ngọc Du'		    , '1997-05-08'  , 'M'       , '13'  , '15'      , '45'          , 'MSSQL15'     , N'cần cố gắng'),
                    (N'Nguyễn Thế Đức'	    , '1995-07-19'  , 'M'       , '15'  , '17'      , '45'          , 'MSSQL17'     , NULL),
                    (N'Trịnh Hà Hải'	    , '1997-10-21'  , 'M'       , '17'  , '10'      , '50'          , 'MSSQL10'     , N'chú ý trình bày'),
                    (N'Phạm Văn Huy'	    , '1997-08-27'  , 'M'       , '10'  , '18'      , '40'          , 'MSSQL18'     , N'Cần cố gắng'),
                    (N'Nguyễn Thị Mỵ'	    , '1995-07-24'  , 'F'       , '17'  , '15'      , '45'          , 'MSSQL15'     , N'Bài làm khá'),
                    (N'Ninh Thi Hien'	    , '1995-10-18'  , 'F'       , '15'  , '15'      , '40'          , 'MSSQL13'     , N'Cần phát huy'),
                    (N'Tống Thị Nhung'	    , '1992-06-07'  , 'F'	    , '19'  , '17'      , '48'          , 'MSSQL17'     , N'Bài làm rất tốt'),
                    (N'Vũ Văn Ước'		    , '1996-03-02'  , 'M'       , '13'  , '18'      , '40'          , 'MSSQL18'     , Null),
                    (N'Trần Lưu Võ'		    , '1996-10-15'  , 'M'       , '10'  , '15'      , '40'          , 'MSSQL13'     , Null);
